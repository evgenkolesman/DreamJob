...
public class MemStore implements Store {
    ...
    private MemStore() {
        ...
        candidates.put(1, new Candidate(1, "Junior Java", "Voronezh"));
        candidates.put(2, new Candidate(2, "Middle Java", "Moscow"));
        candidates.put(3, new Candidate(3, "Senior Java", "Krakow"));
    }
